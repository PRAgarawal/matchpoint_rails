...
var DeleteModalCtrl = function ($scope, $modalInstance, resources, object, name, pathAfterSuccess,
                                callback) {
  $scope.name = name;

  // IE8 doesn't like the keyword 'delete' in JS source files.  Workaround by setting it as a
  // string, just so we can load this file in IE8 for 'unsupported browser' modals.
...
var GenericModalCtrl = function ($scope, $modalInstance, callback, message, title, buttonText,
                                 isInformational) {
...
var ErrorModalCtrl = function ($scope, $modalInstance, message, title) {
